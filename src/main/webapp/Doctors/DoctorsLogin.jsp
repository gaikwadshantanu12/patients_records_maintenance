...
<html>
	<head>
		...
		<title>Doctor's Log In Screen</title>
							...
							<form action="../DoctorsLogin" method="POST">
 								...
 								<div class="form-group">
  								...
  								<div class="d-flex justify-content-center mt-5 mb-3">
  									<button type="submit" id="logInBtn" name="logInBtn" class="btn btn-outline-success">Login As Doctor</button>
  								</div>
  								<p class="text-center font-weight-bold mt-5">New Doctor ? <a href="DoctorsSignup.jsp">Register Here</a></p>
							</form>
						</div>
					</div>
				</div>
